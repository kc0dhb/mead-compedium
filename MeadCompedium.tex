...
% Add some guidelines for SNA
  ...
  \subsubsection*{Notes}
   This will make a standard strength semi-sweet mead. You'll want to shoot for around 1.110-1.120 for gravity for a final gravity between 1.004 and 1.014 with final alcohol around 14\% ABV. If it goes dry, you can always add more honey. The reason this uses D-47 is because it is a 14\% alcohol tolerant yeast and many of the others will take this all the way dry.
