...
%TODO find out how much YAN Go-Ferm provides
 ...
 \subsection{Yeast Feeding}
  ...
  of nutrients need to be added in order to keep the fermentation healthy. The Nanaiomo Winemakers have a good bit of detail on nutrient addition for fermentation \cite{nanaiomo-fermentation}
